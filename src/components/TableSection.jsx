...
const tableData = [
    {
        avatar:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRH87TKQrWcl19xly2VNs0CjBzy8eaKNM-ZpA&s",
        name: "Karthik",
        status: "Active",
    },
    {
        ...
        <table className="min-w-full border border-collapse">
            ...
            <tbody>
                {tableData.map((user, index) => (
                    <tr key={index}>
                        <td className="border border-gray-300 px-4 py-2 "><img width={50} height={50} src={user.avatar} alt="User Avatar"/></td>
